...
// PushJSONToRemote posts arbitrary data to some URL as JSON and returns the response, status code,
// and error (if any). The final parameter, client is optional and allows for easy testing.
